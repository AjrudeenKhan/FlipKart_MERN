...
color:#878787;
`
const CreateAcocount = styled(Typography)`
font-size:14px;
text-align:center;
color:#2874f0;
font-weight:600;
  ...
  return (
    <Dialog open= {open} onClose={handleClose} PaperProps={{ sx: { maxWidth: 'unset' } }}>
        <Component>
            ...
            <CreateAcocount onClick={()=>toggleSignup()}>New to Flipkart?Create an account</CreateAcocount>
            </Wrapper>
            :
            <Wrapper>
            ...
            <CreateAcocount>New to Flipkart?Create an account</CreateAcocount>
            </Wrapper>
            }
            </Box>
        </Component>
